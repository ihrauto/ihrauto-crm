...
@section('content')
    ...
    <div class="space-y-6 lg:space-y-8">
        ...
        @can('access work-orders')
            <div class="mb-8">
                <!-- Key Stats (Dynamic Grid: 3 cols for technicians, 4 cols for admins) -->
                <div class="grid grid-cols-2 gap-3 sm:gap-5 @can('access finance') lg:grid-cols-4 @else lg:grid-cols-3 @endcan">
                    ...
                    <!-- Completed Today (only for users with finance access) -->
                    @can('access finance')
                        <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-indigo-100 flex flex-col">
                            <div class="p-4 sm:p-5 flex-1">
                                <div class="flex items-center gap-3 mb-3">
                                ...
                                <div class="flex items-baseline gap-2">
                                    <span
                                        class="text-2xl sm:text-3xl font-bold text-indigo-950">{{ $stats['completed_today'] }}</span>
                    ...
                    <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-indigo-100 flex flex-col">
                        <div class="p-4 sm:p-5 flex-1">
                            ...
                            <div class="flex items-baseline gap-2">
                                <span
                                    class="text-2xl sm:text-3xl font-bold text-indigo-950">{{ \App\Models\WorkOrder::count() }}</span>
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-4">
                    ...
                    <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-inset ring-gray-200 flex flex-col">
                        <div class="p-4 sm:p-5 flex-1">
                            ...
                            <div class="flex items-baseline gap-2">
                                <span
                                    class="text-2xl sm:text-3xl font-bold text-gray-900">{{ $stats['appointments_today'] }}</span>
                    ...
                    <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-inset ring-gray-200 flex flex-col">
                        <div class="p-4 sm:p-5 flex-1">
                            ...
                            <div class="flex items-baseline gap-2">
                                <span
                                    class="text-2xl sm:text-3xl font-bold text-gray-900">{{ $stats['low_stock_count'] }}</span>
                    ...
                    <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-inset ring-gray-200 flex flex-col">
                        <div class="p-4 sm:p-5 flex-1">
                            ...
                            <div class="flex items-baseline gap-2">
                                <span
                                    class="text-2xl sm:text-3xl font-bold text-gray-900">{{ $stats['idle_technicians'] }}</span>
        ...
        {{-- Quick Action Buttons (Full Width, No Heading) --}}
        <div class="grid grid-cols-2 gap-4">
            @can('access check-in')
                <a href="{{ route('checkin', ['openForm' => 'true']) }}"
                    class="flex items-center p-4 rounded-xl border border-indigo-200 bg-white hover:bg-indigo-50 transition group shadow-sm">
                    <div class="p-3 rounded-lg bg-indigo-100 text-indigo-600 group-hover:bg-indigo-200">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <div class="ml-4">
                        <p class="text-base font-semibold text-indigo-900">New Check-in</p>
                        <p class="text-sm text-indigo-500">Register vehicle arrival</p>
                    </div>
                </a>
            @endcan

            @can('access tire-hotel')
                <a href="{{ route('tires-hotel', ['openStore' => 'true']) }}"
                    class="flex items-center p-4 rounded-xl border border-purple-200 bg-white hover-purple-custom transition group shadow-sm">
                    <div class="p-3 rounded-lg bg-purple-100 text-purple-600 hover-icon-purple">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <div class="ml-4">
                        <p class="text-base font-semibold text-purple-900">New Tire Storage</p>
                        <p class="text-sm text-purple-500">Store tires for customer</p>
                    </div>
                </a>
            @endcan
        </div>
        ...
        @can('access work-orders')
            {{-- Today's Schedule (Full Width Below Buttons) --}}
