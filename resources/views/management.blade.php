    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-end gap-3 mb-6">
            ...
            <a href="{{ route('management.reports') }}"
                class="inline-flex items-center justify-center px-4 py-2.5 border border-transparent text-sm font-semibold rounded-lg shadow-sm text-white bg-accent-500 hover:bg-accent-600 transition-all hover:shadow-lg hover:-translate-y-0.5">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
