            ...
            <div class="bg-white shadow-sm ring-1 ring-indigo-100 sm:rounded-xl md:col-span-2">
                <form action="{{ route('work-orders.store') }}" method="POST">
                    ...
                    <div class="flex items-center justify-end gap-x-6 border-t border-indigo-100 px-4 py-4 sm:px-8">
                        ...
                        <button type="submit"
                            class="rounded-md bg-accent-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-accent-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Schedule
                            Work Order</button>
                    </div>
                </form>
            </div>
