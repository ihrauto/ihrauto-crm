...
@section('content')
    <div class="space-y-6">
        ...
        <nav class="text-sm font-medium text-indigo-900/60">
            ...
            <span class="text-indigo-600">Add New Staff Member</span>
        </nav>
        ...
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-2xl font-bold text-indigo-950 tracking-tight">Add New Staff Member</h1>
        </div>

        <!-- Form -->
        <x-card class="border border-indigo-100 shadow-lg ring-1 ring-indigo-50/50">
            <form action="{{ route('management.users.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs text-indigo-500">User emails are unique across the full IHRAUTO CRM platform, not just this tenant.</p>
                        </div>

                        <div>
                            <label for="password" class="text-sm font-semibold text-indigo-900 mb-1.5 block">Password <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs text-indigo-500">Roles determine what parts of the system this user can
                                access.</p>
                        </div>
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-indigo-50">
                    ...
                    <button type="submit"
                        class="bg-accent-500 text-white px-6 py-2.5 rounded-lg uppercase font-bold text-sm tracking-wide hover:bg-accent-600 focus:outline-none focus:ring-4 focus:ring-accent-300 transition-all shadow-md transform hover:-translate-y-0.5">
