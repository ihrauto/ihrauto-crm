            ...
            <div class="p-12 text-center">
                ...
                <div class="mt-6">
                    <button type="button" onclick="document.getElementById('createProductModal').showModal()"
                        class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-accent-500 hover:bg-accent-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
