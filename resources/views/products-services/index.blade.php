        ...
        <div class="mt-4 flex sm:ml-4 sm:mt-0">
            @if($tab === 'parts')
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" @click.away="open = false" type="button"
                        class="inline-flex items-center gap-x-1.5 rounded-md bg-accent-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-accent-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        Add Parts
            ...
            @else
                <button type="button" onclick="document.getElementById('createServiceModal').showModal()"
                    class="block rounded-md bg-accent-500 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-accent-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Add Service
                </button>
            @endif
        </div>
