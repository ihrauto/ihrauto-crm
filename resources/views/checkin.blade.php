        ...
        <div id="active-user-form" class="hidden">
            <x-card>
                ...
                <div class="bg-white rounded-xl p-6 ring-1 ring-indigo-100">
                    ...
                    <div class="flex gap-3">
                        <div class="relative flex-grow">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                <svg class="animate-spin w-5 h-5 text-indigo-600 hidden" id="search-loading" fill="none"
                                    viewBox="0 0 24 24">
                    ...
                    <div id="customer-results" class="mt-4 space-y-4 hidden"></div>
                </div>

                <!-- Cancel Button - Outside the search box -->
                <div class="flex justify-start mt-6">
                    <button type="button"
                        class="cancel-btn inline-flex items-center px-5 py-2.5 border border-gray-300 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all duration-200">
                        Cancel
                    </button>
                </div>

                <!-- Selected Customer Form (Hidden until customer is selected) -->
                <form method="POST" action="{{ route('checkin.store') }}" class="space-y-6 mt-6 hidden"
                    id="selected-customer-form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="selected-customer-info">
                        ...
                        <div class="flex justify-end space-x-4 mt-8">
                            ...
                            <button type="button"
                                onclick="document.getElementById('selected-customer-form').classList.add('hidden'); document.getElementById('customer-search').value = '';"
                ...
                <div class="step-content" id="step-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                        <div>
                            ...
                            <input name="customer_first_name" type="text" required value="{{ old('customer_first_name') }}"
                        ...
                        <div>
                            ...
                            <input name="customer_last_name" type="text" required value="{{ old('customer_last_name') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input name="phone" type="tel" required value="{{ old('phone') }}" placeholder="Phone number"
                                class="block w-full rounded-lg border-0 py-2 px-4 text-indigo-900 ring-1 ring-inset ring-indigo-200 placeholder:text-indigo-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            @error('phone')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input name="postal_code" type="text" value="{{ old('postal_code') }}" placeholder="Zip Code"
                                class="block w-full rounded-lg border-0 py-2 px-4 text-indigo-900 ring-1 ring-inset ring-indigo-200 placeholder:text-indigo-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            @error('postal_code')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-indigo-50/50 p-4 rounded-lg border border-indigo-100">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm text-indigo-800">
                                ...
                                <div><span class="font-medium text-indigo-500">VIN:</span> <span id="review-vin">-</span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function selectCustomer(customer) {
                ...
                // Show the form and hide the search results
                const selectedForm = document.getElementById('selected-customer-form');
                if (selectedForm) {
